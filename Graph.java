...
/////////////////////////////////////////////////////////////
    ...
    {
        int firstIndex = indexOf(first.getLabel());
        int secondIndex = indexOf(second.getLabel());
    ...
    {
        int startIndex = indexOf(start.getLabel());
    ...
    {
        int fromIndex = indexOf(from.getLabel());
        int toIndex = indexOf(to.getLabel());

        return fromIndex != -1 && toIndex != -1 && adjMatrix[fromIndex][toIndex] == 1 && adjMatrix[toIndex][fromIndex] == 1;
    }
    ...
    public int lengthOfPath(Vertex first, Vertex second) 
    {
        ...
        int startIndex = indexOf(first.getLabel());
        int endIndex = indexOf(second.getLabel());
